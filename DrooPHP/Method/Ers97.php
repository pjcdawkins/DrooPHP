...
class DrooPHP_Method_Ers97 extends DrooPHP_Method {
   ...
   * elected.
   *
   * This should be done by dividing the total valid vote by one more than the
   * number of places to be filled. Take the division to two decimal places. If
   * the result is exact that is the quota. Otherwise ignore the remainder, and add 0.01
   *
   * @return int
   */
